...
mat_data = scipy.io.loadmat('/data/hdd0/yuteng.liu/Secpath_DNN/2025_comsol_data_ver2/sec_path_all.mat')
...
np.save('/data/hdd0/yuteng.liu/Secpath_DNN/2025_comsol_data_ver2/secondary_path/ip_test.npy', ip_test)
np.save('/data/hdd0/yuteng.liu/Secpath_DNN/2025_comsol_data_ver2/secondary_path/op_sec_test.npy', op_test)
scipy.io.savemat('/data/hdd0/yuteng.liu/Secpath_DNN/2025_comsol_data_ver2/secondary_path/op_sec_test.mat', {'test_label_sec_all':op_test})

X_train, X_test, y_train, y_test = train_test_split(input_data, target_data, test_size=0.1, random_state=42)
print(X_train.shape, X_test.shape, y_train.shape, y_test.shape)
print(X_test)
np.save('/data/hdd0/yuteng.liu/Secpath_DNN/2025_comsol_data_ver2/input_test.npy', X_test)
np.save('/data/hdd0/yuteng.liu/Secpath_DNN/2025_comsol_data_ver2/target_test.npy', y_test)
...
for fold, (train_index, val_index) in enumerate(kf.split(X_train)):
    ...
    # save_model_path = f'/data/hdd0/yuteng.liu/Secpath_DNN/2025_comsol_data_ver2/secondary_path/best_model_{fold+1}_0522'
    save_model_path = f'/data/hdd0/yuteng.liu/Secpath_DNN/2025_comsol_data_ver2/secondary_path/best_model_{fold+1}_0522_2' #使用np.min的
