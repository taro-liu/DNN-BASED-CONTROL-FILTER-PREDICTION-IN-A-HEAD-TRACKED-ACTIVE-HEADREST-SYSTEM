...
mat_data = scipy.io.loadmat('/data/hdd0/yuteng.liu/Secpath_DNN/2025_comsol_data_ver2/W_control/control_filters_all.mat')
data = mat_data['W'].astype(np.float32)
...
np.save('/data/hdd0/yuteng.liu/Secpath_DNN/2025_comsol_data_ver2/W_control/ip_test.npy', ip_test)
np.save('/data/hdd0/yuteng.liu/Secpath_DNN/2025_comsol_data_ver2/W_control/op_W_test.npy', op_test)
io.savemat('/data/hdd0/yuteng.liu/Secpath_DNN/2025_comsol_data_ver2/W_control/op_W_test.mat', {'test_label_W_all':op_test})

X_train, X_test, y_train, y_test = train_test_split(input_data, target_data, test_size=0.1, random_state=42)
print(X_train.shape, X_test.shape, y_train.shape, y_test.shape)
print(X_test)
np.save('/data/hdd0/yuteng.liu/Secpath_DNN/2025_comsol_data_ver2/W_control/input_test.npy', X_test)
np.save('/data/hdd0/yuteng.liu/Secpath_DNN/2025_comsol_data_ver2/W_control/target_test.npy', y_test)
...
for fold, (train_index, val_index) in enumerate(kf.split(X_train)):
    ...
    train_loader_fold = torch.utils.data.DataLoader(list(zip(X_train_fold, y_train_fold)), batch_size=5, shuffle=True)
    val_loader_fold = torch.utils.data.DataLoader(list(zip(X_val_fold, y_val_fold)), batch_size=1, shuffle=False)
    ...
    save_model_path = f'/data/hdd0/yuteng.liu/Secpath_DNN/2025_comsol_data_ver2/W_control/best_model_{fold+1}_0522_2' 
    # save_model_path = f'/data/hdd0/yuteng.liu/Secpath_DNN/2025_comsol_data_ver2/W_control/best_model_{fold+1}_0522'
